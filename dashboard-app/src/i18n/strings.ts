...
export const strings = {
  ...
  // Settings panel
  settingsTitle: { en: 'Settings', jp: '設定' },
  settingsShift: { en: 'Shift', jp: 'シフト' },
  settingsShiftStart: { en: 'Shift start', jp: 'シフト開始' },
  settingsShiftEnd: { en: 'Shift end', jp: 'シフト終了' },
  settingsBreaks: { en: 'Breaks', jp: '休憩' },
  settingsAddBreak: { en: '+ Add break', jp: '＋ 休憩を追加' },
  settingsRemove: { en: 'Remove', jp: '削除' },
  settingsIntervals: { en: 'Production intervals', jp: '生産区間' },
  settingsColStart: { en: 'Start', jp: '開始' },
  settingsColEnd: { en: 'End', jp: '終了' },
  settingsColLabel: { en: 'Label', jp: 'ラベル' },
  settingsColTarget: { en: 'Target', jp: '目標' },
  settingsDailyTarget: { en: 'Daily target (units)', jp: '日次目標（台）' },
  settingsIdealCt: { en: 'Ideal cycle time (seconds)', jp: '理想サイクルタイム（秒）' },
  settingsIntervalSum: { en: 'Sum of interval targets', jp: '区間目標の合計' },
  settingsSave: { en: 'Save', jp: '保存' },
  settingsCancel: { en: 'Cancel', jp: 'キャンセル' },
  settingsResetDefaults: { en: 'Reset to defaults', jp: '初期値に戻す' },
  settingsShiftReset: { en: 'Shift Reset', jp: 'シフトリセット' },
  settingsShiftResetHint: {
    en: 'Zeros every live counter and starts a new shift. Past data is archived, not deleted.',
    jp: 'すべてのライブカウンターを0にし、新しいシフトを開始します。過去データは保存され、削除されません。',
  },
  settingsShiftResetBtn: { en: 'Reset shift now', jp: '今すぐシフトをリセット' },
  settingsShiftResetConfirm: { en: 'Confirm — zero all counters', jp: '確認 — すべて0にする' },
  settingsShiftResetDone: { en: 'Shift reset ✓', jp: 'シフトをリセットしました ✓' },
  settingsLoading: { en: 'Loading settings…', jp: '設定を読み込み中…' },
  settingsSaveError: { en: 'Could not save — please fix:', jp: '保存できませんでした。修正してください:' },
  settingsLoadError: { en: 'Could not load settings', jp: '設定を読み込めませんでした' },
  settingsSaved: { en: 'Saved ✓', jp: '保存しました ✓' },
